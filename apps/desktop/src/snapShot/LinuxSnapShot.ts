...
const EXTENSION = "org.gnome.Shell.Extensions.RUNESnapShot";
const EXTENSION_PATH = "/org/gnome/Shell/Extensions/RUNESnapShot";
...
export class LinuxCaptureConnection {
  ...
  async captureExtension(appId: string, options?: FeedbackOptions): Promise<LinuxWindowSnapshot> {
    ...
    if (result !== RequestNameReply.PRIMARY_OWNER) {
      throw new Error("Another RUNE Code instance is capturing a window. Try again.");
    }
