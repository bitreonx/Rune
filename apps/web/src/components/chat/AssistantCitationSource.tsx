...
import type { AssistantCitation, MessageId, ScopedThreadRef } from "@rune/contracts";
...
const COMMENT_HIGHLIGHT_NAME = "RUNE-assistant-citation-comment";
...
export function observeAssistantCitationSource({
  ...
  const clear = () => {
    if (highlighted && CSS.highlights.get("RUNE-assistant-citation") === highlighted) {
      CSS.highlights.delete("RUNE-assistant-citation");
    }
    highlighted = null;
    ownedRange = null;
  ...
  const highlight = () => {
    ...
    if (typeof Highlight !== "undefined" && typeof CSS !== "undefined" && CSS.highlights) {
      ...
      CSS.highlights.set("RUNE-assistant-citation", highlighted);
      ownedRange = range;
    ...
    if (!pulseAnimation) {
      ...
      pulseAnimation.id = "RUNE-assistant-citation-pulse";
