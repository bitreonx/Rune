...
import type { PullRequestMergeMethod } from "@rune/contracts";
import { create } from "zustand";
import { normalizeProjectPathForComparison } from "./lib/projectPaths";

export const PERSISTED_STATE_KEY = "rune:ui-state:v1";
const THREAD_CHANGED_FILES_EXPANSION_VERSION = 1;
const LEGACY_PERSISTED_STATE_KEYS = [
  "rune:renderer-state:v8",
  "rune:renderer-state:v7",
  "rune:renderer-state:v6",
  "rune:renderer-state:v5",
  "rune:renderer-state:v4",
  "rune:renderer-state:v3",
