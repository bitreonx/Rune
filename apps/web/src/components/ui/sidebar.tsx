  ...
  return (
    <SidebarInstanceContext value={instanceContextValue}>
      ...
      >
        ...
        <div
          className={cn(
            "relative w-(--sidebar-width) bg-transparent transition-[width] duration-(--rune-motion-standard) ease-[cubic-bezier(0.22,1,0.36,1)]",
        ...
        <div
          className={cn(
            "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-(--rune-motion-standard) ease-[cubic-bezier(0.22,1,0.36,1)] md:flex",
            side === "left"
        ...
        >
          <div
            className="flex h-full w-full flex-col overflow-hidden bg-sidebar surface-grain group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow-sm/5"
            data-sidebar="sidebar"
...
function SidebarTrigger({ className, onClick, ...props }: React.ComponentProps<typeof Button>) {
  ...
  return (
    ...
    >
      ...
      <span className="sr-only">{isOpen ? "Minimize sidebar" : "Expand sidebar"}</span>
    </Button>
  );
}
