...
export const ProviderSessionRuntime = Schema.Struct({
  ...
  serviceConnectionId: Schema.optionalKey(Schema.NullOr(TrimmedNonEmptyString)),
  modelProfileId: Schema.optionalKey(Schema.NullOr(TrimmedNonEmptyString)),
  runtimeManifestFingerprint: Schema.optionalKey(Schema.NullOr(TrimmedNonEmptyString)),
  runtimeManifestVersion: Schema.optionalKey(Schema.NullOr(Schema.Int)),
...
>()("rune/persistence/ProviderSessionRuntime/ProviderSessionRuntimeRepository") {}
...
const ProviderSessionRuntimeRawDbRowSchema = Schema.Struct({
  ...
  serviceConnectionId: Schema.Unknown,
  modelProfileId: Schema.Unknown,
  runtimeManifestFingerprint: Schema.Unknown,
  runtimeManifestVersion: Schema.Unknown,
    ...
    execute: (runtime) =>
      sql`
        ...
        DO UPDATE SET
          ...
          runtime_manifest_fingerprint = excluded.runtime_manifest_fingerprint,
          runtime_manifest_version = excluded.runtime_manifest_version,
