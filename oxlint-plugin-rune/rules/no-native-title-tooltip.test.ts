...
const rule = createOxlintRuleHarness("rune/no-native-title-tooltip", {
  filename: "fixture.tsx",
});

describe("rune/no-native-title-tooltip", () => {
  rule.valid(
  ...
  rule.valid("allows document.title assignments", `document.title = "Thread · Rune";`);
