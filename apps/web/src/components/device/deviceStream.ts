 ...
 * through the RUNE proxy. One class handles both platforms because the hub
 ...
 */
import type { DeviceHubAccess } from "@rune/client-runtime/state/deviceHubAccess";
import { withDeviceHubQuery } from "@rune/client-runtime/state/deviceHubAccess";
import type { DevicePlatform } from "@rune/contracts";
