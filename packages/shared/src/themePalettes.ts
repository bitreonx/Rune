export const BUILT_IN_THEME_IDS = ["rune-chat", "grove", "ocean", "ember", "iris"] as const;

/** The mobile app's own hand-tuned palette, which is not part of the built-in library. */
export const MOBILE_DEFAULT_THEME_ID = "rune";
...
export const RUNE_CHAT_THEME: ThemeDefinition = {
  id: "rune-chat",
  label: "RUNE Chat",
  appearance: "light",
  colors: {
