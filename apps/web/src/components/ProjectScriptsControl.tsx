...
const NO_FILE_SCRIPTS: ReadonlyArray<RuneProjectFileScript> = [];

interface ProjectScriptsControlProps {
  scripts: ReadonlyArray<ProjectScript>;
  /** Scripts declared in the project's checked-in rune.json, offered for import. */
  fileScripts?: ReadonlyArray<RuneProjectFileScript>;
...
export default function ProjectScriptsControl({
  ...
  const importFileScript = async (fileScript: RuneProjectFileScript) => {
  ...
  const importMenuItems = importableScripts.length > 0 && (
    <>
      ...
      <MenuGroup>
        <MenuGroupLabel>From rune.json</MenuGroupLabel>
