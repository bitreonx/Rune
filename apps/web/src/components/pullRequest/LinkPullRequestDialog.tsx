import { changeRequestUrlFor as changeRequestWebUrl } from "@rune/shared/changeRequestUrl";
export { changeRequestUrlFor as changeRequestWebUrl } from "@rune/shared/changeRequestUrl";
import {
  pullRequestHostOf,
