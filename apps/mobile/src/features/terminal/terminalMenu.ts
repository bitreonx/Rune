import { type KnownTerminalSession } from "@rune/client-runtime/state/terminal";
import { DEFAULT_TERMINAL_ID, type ProjectScript } from "@rune/contracts";
import { nextTerminalId, resolveTerminalSessionLabel } from "@rune/shared/terminalLabels";
