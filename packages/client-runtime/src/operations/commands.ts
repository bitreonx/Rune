...
export type SetThreadTemporaryInput = CommandInput<"thread.temporary.set">;
...
export const setThreadTemporary: (input: SetThreadTemporaryInput) => CommandEffect = Effect.fn(
  "EnvironmentCommands.setThreadTemporary",
)(function* (input) {
  return yield* dispatch({
    ...input,
