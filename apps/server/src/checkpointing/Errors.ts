import { NonNegativeInt, ThreadId, type VcsError } from "@rune/contracts";
...
export class CheckpointBaselineMissingError extends Schema.TaggedError<CheckpointBaselineMissingError>()(
