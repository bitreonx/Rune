...
export function selectGrokPermissionOptionId(
  ...
  // Grok 4.6 often omits allow_always. RUNE still offers "Always allow this session".
...
export function makeGrokAdapter(grokSettings: GrokSettings, options?: GrokAdapterLiveOptions) {
  return Effect.gen(function* () {
    ...
    /** Surface Grok plan.md as RUNE's proposed-plan card (while writing + on exit). */
      ...
      withThreadLock(
        ...
        Effect.gen(function* () {
          ...
          const acp = yield* makeGrokAcpRuntime({
            ...
            clientInfo: { name: "rune", version: "0.0.0" },
            ...(mcpSession
              ? {
                  mcpServers: [
                    {
          ...
          const started = yield* Effect.gen(function* () {
            ...
            // Capture plan into RUNE proposed-plan UI and abandon the native gate so
