...
import type { VcsDriverKind, VcsError, VcsRepositoryIdentity } from "@rune/contracts";
import { VcsUnsupportedOperationError } from "@rune/contracts";
...
>()("@rune/server/vcs/VcsDriverRegistry") {}
