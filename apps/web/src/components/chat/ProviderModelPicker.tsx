...
export const ProviderModelPicker = memo(function ProviderModelPicker(props: {
  ...
  const activeBadge =
    activeEntry !== null
      ? instanceBadgePresentation(activeEntry, props.instanceEntries)
      : { show: false, content: "initials" as const };
    ...
    >
      ...
      >
        <span className="flex min-w-0 flex-1 items-center gap-1.5">
          {activeEntry ? (
            <ProviderInstanceIcon
              ...
              showBadge={activeBadge.show}
              badgeContent={activeBadge.content}
              {...(activeBadge.logoUrl ? { badgeLogoUrl: activeBadge.logoUrl } : {})}
              className="size-4"
        ...
        <span aria-hidden="true" className="flex items-center">
          <ComposerControlChevron open={isMenuOpen} />
        </span>
      </PopoverTrigger>
      <PopoverPopup
        align="start"
