...
const CONNECTIONS_KEY = "rune.connections";
const AGENT_AWARENESS_DEVICE_ID_KEY = "rune.agent-awareness.device-id";
const AGENT_AWARENESS_REGISTRATION_KEY = "rune.agent-awareness.registration";
const RECENT_THREAD_SHORTCUTS_KEY = "rune.recent-thread-shortcuts";
...
>()("@rune/mobile/persistence/MobileStorage") {}
