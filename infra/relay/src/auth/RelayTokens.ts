...
import { encodeOAuthScope, parseAllowedOAuthScope } from "@rune/shared/oauthScope";
import {
...
const LINK_CHALLENGE_TYP = "rune-link-challenge+jwt";
const ACCESS_TOKEN_TYP = "rune-relay-dpop-access+jwt";
