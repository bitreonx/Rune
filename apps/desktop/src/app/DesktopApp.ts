...
export class DesktopDevelopmentBackendPortRequiredError extends Schema.TaggedErrorClass<DesktopDevelopmentBackendPortRequiredError>()(
  ...
  override get message(): string {
    return "RUNE_PORT is required in desktop development.";
  }
}
...
const bootstrap = Effect.gen(function* () {
  ...
  // Show native feedback before port discovery, backend startup, or renderer
  // readiness can delay the first visible response from the desktop app.
