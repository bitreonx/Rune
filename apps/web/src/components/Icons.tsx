...
export const OpenRouterIcon: Icon = ({ className, ...props }) => (
  <svg {...props} viewBox="0 0 24 24" fill="none" className={cn("text-foreground", className)}>
    ...
    />
    <path
      d="m8 8.25 4-1.75 4 1.75v4.8l-4 1.75-4-1.75v-4.8Z"
      stroke="currentColor"
      strokeWidth="1.4"
      strokeLinejoin="round"
    />
    <path d="M12 7v7.8M8.15 8.5l7.7 4.1" stroke="currentColor" strokeWidth="1.2" />
  </svg>
);
