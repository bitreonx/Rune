...
import { type EnvironmentMachineKind, resolveEnvironmentMachineKind } from "@rune/contracts";
...
function CacheEnvironmentRow(props: {
  ...
  return (
    ...
    >
      ...
      >
        <Text className="font-rune-medium tabular-nums text-danger-foreground" numberOfLines={1}>
