 ...
 * environment session with read scope (operate scope for input and tuning). Reusing the RUNE
 * origin is also what makes remote connections work unchanged — Tailscale and
 * RUNE Connect already carry `/api/*` and WebSocket upgrades for the app itself.
 *
