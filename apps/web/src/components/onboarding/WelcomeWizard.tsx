...
import { CommandId, ProviderDriverKind, ThreadId } from "@rune/contracts";
...
import { useRuneConnectAuthPrompt } from "../clerk/useRuneConnectAuthPrompt";
...
function ConnectAccountOption({
  ...
  const { openAuthPrompt } = useRuneConnectAuthPrompt();
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="flex-1">RUNE Connect</span>
      ...
      <CollapsiblePanel keepMounted>
        <div className="px-3 pb-3">
          ...
          <CommandBlock command="npx rune connect" className="mt-3" />
          <p className="mt-3 text-xs text-muted-foreground">
            Keep RUNE running. Select the computers you want to set up above.
          </p>
        </div>
      </CollapsiblePanel>
    </Collapsible>
      ...
      >
        ...
        <Collapsible>
          ...
          <CollapsiblePanel className="pt-3">
            ...
            <CommandBlock command="npx rune pair" className="mt-2" />
            <p className="mt-2 text-xs leading-relaxed text-muted-foreground">
              Start RUNE first, or run <code className="font-mono">npx rune serve</code>. Add{" "}
