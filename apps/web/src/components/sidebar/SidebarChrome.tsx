...
export const SidebarChromeHeader = memo(function SidebarChromeHeader({
  ...
  return (
    <SidebarHeader
      ...
      className={cn(
        "rune-sidebar-header @container/sidebar-header relative h-[var(--workspace-topbar-height)] shrink-0 flex-row items-center bg-[var(--rune-sidebar-surface)] px-3 py-0 md:px-0",
...
function SidebarBrand({ onBackdrop }: { onBackdrop: boolean }) {
  return (
    <Link
      aria-label={`Go to ${APP_BASE_NAME} workspace`}
...
export const SidebarChromeFooter = memo(function SidebarChromeFooter() {
  return (
    <SidebarFooter
      className="rune-sidebar-footer bg-[var(--rune-sidebar-surface-subtle)] p-[var(--sidebar-content-inset)]"
