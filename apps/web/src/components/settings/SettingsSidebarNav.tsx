  ...
  return (
    <>
      <SidebarContent
        ...
        data-rune-sidebar-scope="settings"
      >
        <SidebarGroup
          className="gap-2 p-[var(--sidebar-content-inset)]"
          data-rune-sidebar-section="search"
        >
          <div
            className="flex h-8 items-center gap-2 rounded-md bg-[var(--rune-sidebar-surface-subtle)] px-2 py-1.5 text-sm font-medium text-sidebar-muted-foreground hover:bg-sidebar-row-hover hover:text-sidebar-foreground"
          ...
          <SidebarMenu
            className="ps-px"
            data-rune-sidebar-section="settings"
              ...
              ? results.map((item, index) => (
                  <SidebarMenuItem key={item.id} role="presentation">
                    <SidebarMenuButton
                      ...
                      data-rune-sidebar-row="settings-result"
                      tabIndex={-1}
                      size="sm"
              ...
              : SETTINGS_NAV_ITEMS.map((item) => {
                  ...
                  return (
                    <SidebarMenuItem key={item.to}>
                      <SidebarMenuButton
                        isActive={isActive}
                        data-rune-sidebar-row="settings"
