...
function normalizedMimeType(attachment: ComposerFileAttachment): string {
...
export const ComposerFileAttachmentChip = memo(function ComposerFileAttachmentChip(props: {
  ...
  return (
    <div
      ...
      data-composer-file-attachment-has-path={hasPath ? "true" : "false"}
    ...
    >
      <button
        ...
        data-composer-file-attachment-preview="rune-viewer"
      >
        <span
      ...
      <Menu>
        ...
        <MenuPopup align="end" side="top" className="min-w-48">
          ...
          <MenuItem
            disabled={!hasPath}
            onClick={hasPath ? props.onRevealInFiles : undefined}
            title={hasPath ? undefined : "Unavailable without a local path."}
          >
            <FolderOpenIcon className="size-4" />
            {hasPath ? "Reveal in RUNE Files" : "Reveal in RUNE Files (unavailable)"}
          </MenuItem>
          <MenuItem
            disabled={!hasPath}
            onClick={hasPath ? props.onRevealInExplorer : undefined}
            title={hasPath ? undefined : "Unavailable without a local path."}
          >
            <FolderOpenIcon className="size-4" />
            {hasPath ? "Reveal in system Explorer" : "Reveal in system Explorer (unavailable)"}
          </MenuItem>
          <MenuSeparator />
