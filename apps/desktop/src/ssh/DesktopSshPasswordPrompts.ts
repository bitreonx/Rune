import type { DesktopSshPasswordPromptRequest } from "@rune/contracts";
import { DesktopSshPasswordPromptResolutionInputSchema } from "@rune/contracts";
import type { SshPasswordRequest } from "@rune/ssh/auth";
...
export class DesktopSshPromptWindowUnavailableError extends Schema.TaggedErrorClass<DesktopSshPromptWindowUnavailableError>()(
  ...
  override get message(): string {
    ...
    return `RUNE window is unavailable during ${this.stage} for SSH authentication to ${this.destination} (request: ${request}).`;
  }
}
...
>()("@rune/desktop/ssh/DesktopSshPasswordPrompts") {}
