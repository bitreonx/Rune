...
// per-command cache lookups in @rune/shared/shell.
//
...
// command-resolution cache in @rune/shared/shell, so a backward wall-clock
...
>()("@rune/server/process/externalLauncher") {}
