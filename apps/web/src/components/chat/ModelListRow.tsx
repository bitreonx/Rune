import { type ProviderDriverKind, type ProviderInstanceId } from "@rune/contracts";
...
export const ModelListRow = memo(function ModelListRow(props: {
  ...
  const ProviderIcon = getProviderBrandPresentation(String(props.driverKind))?.icon ?? null;
