...
export function resolveEnvironmentIdentificationMode(input: {
  ...
  // The unhydrated snapshot cannot safely represent a persisted preference. Use the quiet
  // product default instead of briefly mounting artwork or hiding environment context.
  if (!input.settingsHydrated) return "pill";
