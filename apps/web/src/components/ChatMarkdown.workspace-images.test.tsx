...
describe("ChatMarkdown workspace images", () => {
  ...
  it("loads every Windows workspace path form through a signed asset URL", () => {
    const imagePath = "C:/Users/shawn/project/.rune/workspace-image.svg";
    const html = render(
      [
        "![relative](.rune/workspace-image.svg)",
        `![absolute](${imagePath})`,
    ...
    expect(testState.resources).toEqual([
      {
        ...
        path: "C:\\Users\\shawn\\project\\.rune\\workspace-image.svg",
      },
  ...
  it("uses a static placeholder while a signed asset URL loads", () => {
    ...
    const html = render("![loading](.rune/workspace-image.svg)");
