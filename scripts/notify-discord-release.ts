  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new RUNE prerelease is available for nightly testers."
          : "A new RUNE latest release is available.",
...
).pipe(Command.withDescription("Post a Rune release announcement to Discord."));
