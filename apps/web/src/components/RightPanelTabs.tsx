import type { ContextMenuItem, PreviewSessionSnapshot, PullRequestState } from "@rune/contracts";
...
export function RightPanelTabs(props: RightPanelTabsProps) {
  ...
  return (
    ...
    >
      <div
        className={cn(
          "rune-right-panel-tabbar flex h-[var(--workspace-topbar-height)] min-h-[var(--workspace-topbar-height)] shrink-0 items-center gap-1 pl-2",
      ...
      <div
        className="rune-right-panel-content flex min-h-0 flex-1 flex-col"
