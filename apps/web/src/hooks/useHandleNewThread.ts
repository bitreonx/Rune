...
import { DEFAULT_RUNTIME_MODE, type ScopedProjectRef, type ThreadId } from "@rune/contracts";
...
import { resolveDefaultThreadEnvMode } from "@rune/shared/threadEnvMode";
import { readThreadShell, useProjects, useThread } from "../state/entities";
import { resolveNewDraftStartFromOrigin } from "../lib/chatThreadActions";
import { readRuneProjectFileDefaultThreadEnvMode } from "../lib/runeProjectFileDefaults";
...
export function useNewThreadHandler() {
  ...
  return useCallback(
    (
      ...
      // The shared resolver owns the priority order. The rune.json read is
      ...
      const resolveDefaultEnvMode = async (): Promise<DraftThreadEnvMode> => {
        ...
        return resolveDefaultThreadEnvMode({
          ...
          projectFile: consultProjectFile
            ? await readRuneProjectFileDefaultThreadEnvMode(
