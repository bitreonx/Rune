import type { EnvironmentRpcSubscriptionObservation } from "@rune/client-runtime/rpc";
import { type BackgroundScope, type EnvironmentId, WS_METHODS } from "@rune/contracts";
