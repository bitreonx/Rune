...
export default defineConfig({
  ...
  lint: {
    ...
    jsPlugins: ["./oxlint-plugin-rune/index.ts"],
    categories: {
      correctness: "warn",
      suspicious: "warn",
      perf: "warn",
    ...
    rules: {
      ...
      "eslint/no-restricted-imports": [
        "error",
        {
          paths: [
            {
              name: "@rune/client-runtime",
              message:
                "Import from an explicit @rune/client-runtime/* subpath. The package has no root export.",
            },
            {
      ...
      "rune/no-global-process-runtime": "error",
      "rune/no-inline-schema-compile": "warn",
      "rune/no-manual-effect-runtime-in-tests": "error",
      "rune/no-native-title-tooltip": "error",
      "rune/namespace-node-imports": "error",
    },
    overrides: [
      {
        // The one place that reads the host platform to seed the injected references.
        files: ["packages/shared/src/hostProcess.ts"],
        rules: { "rune/no-global-process-runtime": "off" },
      },
      {
        files: ["apps/mobile/src/**"],
        rules: { "rune/no-mobile-uniwind-theme-escape-hatches": "error" },
      },
      {
        ...
        files: [
          ...
          "apps/mobile/src/native/RUNEComposerEditor.ios.tsx",
          "apps/mobile/src/native/RUNEComposerEditor.native.tsx",
        ],
        rules: {
          "rune/no-mobile-uniwind-theme-escape-hatches": ["error", { allowUniwindTheme: true }],
        },
      },
      ...
      ...Object.entries({
        ...
        return { files: [file], rules: { "rune/no-manual-effect-runtime-in-tests": rule } };
      }),
    ],
    options: {
