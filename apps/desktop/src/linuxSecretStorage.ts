...
function getGnomeKeyringRemediationMessage(): string {
  return "RUNE could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart RUNE.";
}

function getKWalletRemediationMessage(): string {
  return "RUNE could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart RUNE.";
}
