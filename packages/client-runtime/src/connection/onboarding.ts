import type { DesktopSshEnvironmentTarget, EnvironmentId } from "@rune/contracts";
import { resolveRemotePairingTarget } from "@rune/shared/remote";
...
>()("@rune/client-runtime/connection/onboarding/ConnectionOnboarding") {}
