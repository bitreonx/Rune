...
import { ConnectionTransientError } from "@rune/client-runtime/connection";
...
export const CONNECTION_CATALOG_KEY = "rune.connection-catalog.v1";
export const LEGACY_CONNECTIONS_KEY = "rune.connections";
