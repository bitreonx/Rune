  ...
  const checkpoints: VcsDriver.VcsCheckpointOps = {
    captureCheckpoint: Effect.fn("GitVcsDriver.checkpoints.captureCheckpoint")(function* (input) {
      ...
      const tempIndexPath = path.join(
        gitCommonDir,
        `rune-checkpoint-index-${NodeCrypto.randomUUID()}`,
      );
      const commitEnv: NodeJS.ProcessEnv = {
        ...process.env,
        GIT_INDEX_FILE: tempIndexPath,
        GIT_AUTHOR_NAME: "RUNE",
        GIT_AUTHOR_EMAIL: "rune@users.noreply.github.com",
        GIT_COMMITTER_NAME: "RUNE",
        GIT_COMMITTER_EMAIL: "rune@users.noreply.github.com",
      };
      ...
      yield* Effect.gen(function* () {
        ...
        const message = `rune checkpoint ref=${input.checkpointRef}`;
