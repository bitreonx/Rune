...
import { parseCliArgs } from "@rune/shared/cliArgs";
import {
  ApprovalRequestId,
...
export const makeClaudeAdapter = Effect.fn("makeClaudeAdapter")(function* (
  ...
  const handleSystemMessage = Effect.fn("handleSystemMessage")(function* (
    ...
    switch (message.subtype) {
      ...
      case "notification":
        ...
        return;
      // Inner protocol/UX details with no RUNE surface today — consumed
  ...
  const handleSdkMessage = Effect.fn("handleSdkMessage")(function* (
    ...
    // Wire-only command bookkeeping has no user-facing RUNE lifecycle.
  ...
  const startSession: ClaudeAdapterShape["startSession"] = Effect.fn("startSession")(
    function* (input) {
      ...
      const handleResumeDialog = Effect.fn("handleResumeDialog")(function* (
        ...
        // The question copy lives in @rune/shared/claudeCompaction because
      ...
      // A permission launch arg is folded into the mode RUNE sends rather than
      ...
      const queryOptions: ClaudeQueryOptions = {
        ...
        canUseTool,
        // claudeEnvironment spreads last so manually configured environment
        // variables (Advanced environment variables) outrank the alias pins.
        env: { ...customModelAliasEnv, ...claudeEnvironment },
