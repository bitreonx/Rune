...
/** Natural width used by the context strip before any controls move to overflow. */
...
export function resolveRestingComposerControlsLayout(
  ...
  // Growing the overflow menu is unconditional, while restoring a block needs
  // a pixel of slack so fractional font measurements cannot oscillate it.
  if (previous) {
