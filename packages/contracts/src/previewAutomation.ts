...
const URL_GUIDANCE =
  "Absolute http(s) URL or a schemeless host such as rune.dev or localhost:5173. Schemeless public hosts use https; loopback hosts use http.";
...
/** A `RUNE-code` MCP tool was called with a credential that does not carry its capability. */
