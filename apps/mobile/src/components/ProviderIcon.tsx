  ...
  if (iconKey === "antigravity") {
    return (
      <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
        <Path
          fill="#4285F4"
          d="M12 1.5c.47 0 .86.34.96.8l1.38 6.36 5.36-3.66a.96.96 0 0 1 1.35 1.25l-3.68 5.35 6.33 1.4a.96.96 0 0 1 0 1.87l-6.33 1.4 3.68 5.35a.96.96 0 0 1-1.35 1.25l-5.36-3.66-1.38 6.36a.96.96 0 0 1-1.92 0l-1.38-6.36-5.36 3.66a.96.96 0 0 1-1.35-1.25l3.68-5.35-6.33-1.4a.96.96 0 0 1 0-1.87l6.33-1.4-3.68-5.35a.96.96 0 0 1 1.35-1.25l5.36 3.66L10.08 2.3c.1-.46.5-.8.96-.8Z"
        />
        <Path fill="#A142F4" d="M12 7.5 14.2 12 12 16.5 9.8 12 12 7.5Z" />
      </Svg>
    );
  }
