...
import { isDevProxiedPath } from "@rune/shared/devProxy";
import { decodeOtlpTraceRecords } from "@rune/shared/observability";
...
const DESKTOP_RENDERER_ORIGINS = ["rune://app", "rune-dev://app"];
...
export const browserApiCorsLayer = Layer.unwrap(
  Effect.gen(function* () {
    ...
    //
    // RUNE_DEV_ALLOWED_ORIGINS covers dev servers reached from a second
