...
const legacyHref =
  "rune-citation://v1/a/b/c?text=A+quote+%26+a+newline.%0A&start=0&end=21&prefix=&suffix=+Next.";
...
describe("assistant citation references", () => {
  ...
  it("round-trips complete quote data without a server origin", () => {
    ...
    expect(href).toMatch(
      /^rune-citation:\/\/v1\/environment%2Fremote\/thread%3Aone\/assistant%3Fone\?/,
    );
  ...
  it.each([
    ...
    "rune-citation://v2/a/b/c?text=quote&start=0&end=5&prefix=&suffix=",
    "rune-citation://v1/%ZZ/b/c?text=quote&start=0&end=5&prefix=&suffix=",
    "rune-citation://v1/a/b/c?text=quote&start=NaN&end=5&prefix=&suffix=",
    "rune-citation://v1/a/b/c?text=quote&start=5&end=0&prefix=&suffix=",
    "rune-citation://v1/a/b/c?text=quote&start=0&end=9007199254740992&prefix=&suffix=",
    "rune-citation://v1/a/b/c?text=quote&start=0&end=5&prefix=&suffix=&text=other",
    "rune-citation://v1/a/b/c?text=quote&start=0&end=5&prefix=&suffix=&unknown=value",
    "rune-citation://v1/a/b/c?text=quote&start=0&end=5&prefix=&suffix=&comment=note&unknown=value",
    "rune-citation://v1/a/b/c?text=quote&start=0&end=5&prefix=&suffix=&comment=one&comment=two",
    "rune-citation://v1/a/b/c?text=quote&start=0&end=5&prefix=&suffix=&comment=&comment=",
    "rune-citation://v1/a/b/c?text=quote&start=0&end=5&prefix=&suffix=&comment=one&%63omment=two",
    "rune-citation://v1/a/b/c?text=quote&start=0&end=5&prefix=&comment=note",
    "rune-citation://v1/a/b/c?text=quote&start=0&end=5&prefix=&suffix=&text=other&comment=note",
    "rune-citation://v1/a/b/c?text=&start=0&end=5&prefix=&suffix=",
    "rune-citation://v1/a/b/c?text=quote&start=0&end=5&prefix=&suffix=#unexpected",
  ...
  it("keeps each user comment bound to its quote in provider JSON", () => {
    ...
    expect(expanded).not.toContain("rune-citation://");
  });
  ...
  it("shows the full quote in clients without source navigation and leaves regular messages alone", () => {
    ...
    expect(rendered).not.toContain("rune-citation:");
