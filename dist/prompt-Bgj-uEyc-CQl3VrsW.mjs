...
//#region node_modules/.pnpm/@voidzero-dev+vite-plus-cor_9ee31ae90aa32dad556c960eb1521494/node_modules/@voidzero-dev/vite-plus-core/dist/rolldown/shared/prompt-Bgj-uEyc.mjs
...
var x = class {
	...
	prompt() {
		return new Promise((u, F) => {
			...
			}, this.input.pipe(e), this.rl = readline.createInterface({
				input: this.input,
				output: e,
				tabSize: 2,
				prompt: "",
				escapeCodeTimeout: 50
			}), readline.emitKeypressEvents(this.input, this.rl), this.rl.prompt(), this.opts.initialValue !== void 0 && this._track && this.rl.write(this.opts.initialValue), this.input.on("keypress", this.onKeypress), d$1(this.input, true), this.output.on("resize", this.render), this.render(), this.once("submit", () => {
