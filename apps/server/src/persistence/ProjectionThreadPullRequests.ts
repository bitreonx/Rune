import { normalizeThreadPullRequestKey } from "@rune/shared/threadPullRequests";
import {
  IsoDateTime,
  PositiveInt,
  ThreadId,
...
>()("RUNE/persistence/ProjectionThreadPullRequests/ProjectionThreadPullRequestRepository") {}
