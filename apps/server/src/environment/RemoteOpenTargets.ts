 ...
 */
import { type RemoteOpenTarget } from "@rune/contracts";
import { HostProcessHostname } from "@rune/shared/hostProcess";
import * as NetService from "@rune/shared/Net";
import { readTailscaleStatus } from "@rune/tailscale";
...
>()("@rune/server/environment/RemoteOpenTargets") {}
