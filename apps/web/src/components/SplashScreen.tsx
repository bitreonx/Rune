    ...
    >
      <div className="flex w-full max-w-xs flex-col items-center text-center">
        <div className="rune-splash-mark flex size-28 items-center justify-center rounded-[2rem] border border-border/60 bg-card/55 shadow-[0_18px_60px_-28px_color-mix(in_srgb,var(--primary)_70%,transparent)] backdrop-blur-sm">
          <img
            alt=""
            className="hidden size-24 object-contain dark:block"
            src="/rune-animated-loader.svg"
          />
          <img
            alt=""
            className="block size-24 object-contain opacity-75 brightness-0 dark:hidden"
            src="/rune-animated-loader.svg"
          />
        </div>
        ...
        <div className="mt-3 flex items-center gap-2 text-xs text-muted-foreground">
          <span className="rune-splash-status-dot size-1.5 rounded-full bg-primary" />
