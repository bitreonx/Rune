...
const BRAND_MARK_SOURCE =
  appVariant === "development"
    ? require("../../../../assets/dev/rune-blueprint-ios-1024.png")
    : appVariant === "preview"
      ? require("../../../../assets/nightly/rune-nightly-ios-1024.png")
      : require("../../../../assets/prod/rune-black-ios-1024.png");
    ...
    <View className="flex-row items-center gap-3">
      ...
      <View className="gap-1">
        <View className="flex-row items-center gap-2">
          <Text className="text-lg font-rune-bold tracking-[-0.4px] text-foreground">RUNE</Text>
          <View className="rounded-full bg-subtle px-2 py-1">
            <Text className="text-3xs font-rune-bold tracking-[1.1px] uppercase text-foreground-muted">
              {stageLabel}
            </Text>
          </View>
        </View>
