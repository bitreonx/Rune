...
import { EnvironmentHttpCommonError, PRIMARY_LOCAL_ENVIRONMENT_ID } from "@rune/contracts";
import type { EnvironmentHttpCommonError as EnvironmentHttpCommonErrorType } from "@rune/contracts";
