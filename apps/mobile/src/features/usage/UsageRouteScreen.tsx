      ...
      {props.options.map((option) => {
        ...
        return (
          ...
          >
            <Text
              className={
                active ? "text-sm font-rune-medium text-foreground" : "text-sm text-foreground-muted"
              }
            >
              {option.label}
            </Text>
    ...
    <View className="gap-4 rounded-[24px] border-continuous bg-card p-4">
      <View className="flex-row items-start justify-between gap-3">
        <View className="min-w-0 flex-1 gap-0.5">
          ...
          <Text className="text-4xl font-rune-bold tabular-nums text-foreground">
        ...
        return (
          ...
          >
            <Text
              className={
                active
                  ? "text-xs font-rune-medium uppercase text-foreground"
...
function MetricCell(props: {
  ...
  return (
    <View className="w-1/2 gap-0.5 p-4">
      ...
      <Text className="text-xl font-rune-medium tabular-nums text-foreground">{props.value}</Text>
