import type { ThreadEnvMode } from "@rune/contracts";

/**
 * Canonical priority order for a project's default thread env mode:
 * per-project setting > checked-in rune.json > global server setting.
 *
 ...
 * source that outranks rune.json decided, or the file read settled. While
