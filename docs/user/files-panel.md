...
Workspaces with more than 25,000 entries show the first 25,000 with a notice at the bottom of the tree, so an incomplete listing is always visible rather than silent. The tree keeps itself current: files created, renamed, or deleted while you work appear without reopening the panel.
