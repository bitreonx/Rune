...
export const STARTUP_SPLASH_STATE_CHANNEL = "desktop:startup-splash-state";
export const STARTUP_SPLASH_ACTION_CHANNEL = "desktop:startup-splash-action";
...
export const WINDOW_CLOSE_REQUEST_CHANNEL = "desktop:window-close-request";
export const WINDOW_CLOSE_DECISION_CHANNEL = "desktop:window-close-decision";
...
export const INVALIDATE_LOCAL_ENVIRONMENT_BEARER_TOKEN_CHANNEL =
  "desktop:invalidate-local-environment-bearer-token";
