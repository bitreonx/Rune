...
import { RelayWebClientId } from "@rune/contracts/relay";
...
import { type RpcSession } from "@rune/client-runtime/rpc";
...
beforeEach(() => {
  vi.clearAllMocks();
  vi.stubEnv("VITE_RUNE_RELAY_URL", "https://relay.example.test");
