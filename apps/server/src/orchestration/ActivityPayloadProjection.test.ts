...
describe("projectActivityPayload", () => {
  ...
  it.each([
    ...
    {
      toolName: "mcp__rune-code__preview_navigate",
      result: { content: '{"url":"https://example.com/"}' },
    },
    { tool: "RUNE-code_preview_status", state: { output: '{"url":"https://example.com/"}' } },
    {
      toolName: "mcp__rune_code__preview_snapshot",
      result: {
        content: [
    ...
    ...[
      ...
      toolName: `mcp__rune_code__preview_${action}`,
      result: { content: '{"toolIcon":{"_tag":"website","pageUrl":"https://example.com/"}}' },
    })),
  ...
  it.each([
    ...
    {
      toolName: "mcp__rune-code__preview_evaluate",
      result: { content: '{"url":"https://example.com/"}' },
    },
    {
      toolName: "mcp__rune-code__preview_open",
      result: { isError: true, content: '{"url":"https://example.com/"}' },
    },
    { toolName: "mcp__rune-code__preview_open", result: { content: "malformed JSON" } },
    { toolName: "mcp__rune-code__preview_open", result: { content: '{"url":"about:blank"}' } },
