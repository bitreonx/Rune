...
export const OpenRouterIcon: Icon = ({ className, ...props }) => (
  ...
  >
    {/* OpenRouter mark: a rounded square holding a single flowing curve
        that opens on the right at the top and on the left at the bottom
        (the two C-shapes share the central spine). Uses even-odd fill so
        the white interior reads as the cutout. Raster source of truth:
        `public/logos/openrouter.png`. */}
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M4 3h16a3 3 0 0 1 3 3v12a3 3 0 0 1-3 3H4a3 3 0 0 1-3-3V6a3 3 0 0 1 3-3Zm0 2a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h5.5c1.27 0 2.49-.5 3.39-1.4l2.5-2.5a3.5 3.5 0 0 0 0-4.95l-2.5-2.5A4.83 4.83 0 0 0 9.5 5H4Zm9.5 0a4.83 4.83 0 0 0-1.39 3.65 4.83 4.83 0 0 0 1.39 3.65l2.5 2.5a2.5 2.5 0 0 0 3.54 0L20 13.66V8.5a1 1 0 0 0-1-1h-3.83a3.66 3.66 0 0 0-1.67-2.5Z"
    />
  </svg>
);
...
export const RuneMarkIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 1024 1024" role="img" aria-label="RUNE" fill="currentColor">
    {/* The RUNE mark: a single closed path that draws the angular
        hexagonal glyph used in the brand. `currentColor` lets the host
        theme the icon to match chrome (foreground, accent, etc.). The
        raster source of truth is `public/logos/rune.svg`. */}
    <path d="M 56.83 89.38 L 56.83 223.71 L 657.60 226.22 L 56.00 755.23 L 56.00 934.62 L 448.17 618.39 L 731.03 897.91 L 968.00 898.74 L 834.50 758.57 L 595.86 533.28 L 544.12 531.61 L 925.45 199.52 L 925.45 89.38 Z" />
  </svg>
);

export const AntigravityIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 24 24" role="img" aria-label="Antigravity" fill="currentColor">
    {/* Google Antigravity mark: a single-stroke "A" with a small
        four-point sparkle in the upper-right. The "A" has a wide stance
        and a small inner cut that reads as a crossbar; the sparkle sits
        off the right shoulder. `currentColor` keeps the mark themeable;
        the raster source of truth is `public/logos/antigravity.svg`. */}
    <path d="M11.07 3.4a.9.9 0 0 1 1.86 0l4.62 15.55a.9.9 0 0 1-.86 1.18h-2.46a.9.9 0 0 1-.86-.63l-.92-3.07H9.55l-.92 3.07a.9.9 0 0 1-.86.63H5.31a.9.9 0 0 1-.86-1.18L11.07 3.4Zm-1.5 9.7h4.86l-2.2-7.34h-.46l-2.2 7.34Z" />
    <path d="M19.7 5.4a.6.6 0 0 1 1.14 0l.6 1.74 1.74.6a.6.6 0 0 1 0 1.14l-1.74.6-.6 1.74a.6.6 0 0 1-1.14 0l-.6-1.74-1.74-.6a.6.6 0 0 1 0-1.14l1.74-.6L19.7 5.4Z" />
  </svg>
);

export const OpenCodeIcon: Icon = (props) => {
  const clipPathId = `${useId().replaceAll(":", "")}-opencode-clip`;
  return (
...
export const DeepSeekIcon: Icon = ({ className, ...props }) => (
  <svg
    ...
    viewBox="0 0 24 24"
    fill="none"
    className={cn("fill-[#4D6BFE] text-[#4D6BFE]", className)}
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
