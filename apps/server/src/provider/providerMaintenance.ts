...
import { resolveCommandPath } from "@rune/shared/shell";
...
export const ProviderVersionCache = Context.Reference<Map<string, ProviderVersionCacheEntry>>(
  "@rune/server/providerMaintenance/ProviderVersionCache",
  {
 ...
 * owns that path; anything unproven stays manual-only so RUNE Code never runs
