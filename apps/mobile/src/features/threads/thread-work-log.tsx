...
import { RUNEWordmark } from "../../components/RUNEWordmark";
...
type WorkContentIcon = AppSymbolName | "browser" | "device" | "RUNE-code" | "pull-request";
...
function WorkLogIcon(props: {
  ...
  if (props.icon === "RUNE-code") {
    return (
      <RUNEWordmark height={10} color={props.color} />
    );
  }
  return (
    <SymbolView
...
export function ThreadWorkLog(props: ThreadWorkLogProps) {
  ...
  return (
    <View className="-mx-1 mb-1 px-1 py-0">
      {!onlyToolRows ? (
        <Text className="px-0.5 pb-0.5 font-rune-medium text-2xs text-foreground-muted opacity-60">
          work log
        </Text>
      ) : null}
              ...
              >
                <View className="min-h-8 flex-row items-center gap-1.5">
                  ...
                  <Text className="min-w-0 flex-1 text-xs text-foreground" numberOfLines={1}>
                    <Text
                      className={cn(
                        "font-rune-medium text-foreground",
                  ...
                  <View className="shrink-0 flex-row items-center gap-px">
                    {props.copiedRowId === row.id ? (
                      <Text className="pr-1 font-rune-medium text-3xs text-emerald-600 dark:text-emerald-400">
                        Copied
                      </Text>
                    ) : null}
    ...
    >
      ...
      >
        <View className="min-h-8 flex-row items-center gap-1.5">
            ...
            <>
              ...
              <Text
                className={cn(
                  ...
                  iconIsDestructive && "font-RUNE-medium text-adaptive-rose-600-400",
                )}
          ...
          <View className="shrink-0 flex-row items-center gap-px">
            {props.copied ? (
              <Text className="pr-1 font-RUNE-medium text-3xs text-adaptive-emerald-600-400">
                Copied
              </Text>
            ) : null}
...
export function ThreadWorkGroupToggle(props: {
  ...
  readonly summaryToolIcon?: "browser" | "device" | "RUNE-code" | "pull-request";
  readonly themeAppearance: "light" | "dark";
  readonly toolSurface?: import("@rune/contracts").ToolActivitySurface;
  readonly toolIcon?: ToolActivityIcon;
  ...
  return (
    <View className="-mx-1 px-1 py-0">
      ...
      >
        ...
        <Text className="font-rune-medium text-xs text-foreground opacity-80">
      ...
      >
        <View className="flex-row items-center gap-2">
          ...
          <View className="min-w-0 flex-1 gap-0.5">
            <Text
              key={props.rowSizing.textSizeKey}
              className="font-RUNE-medium text-sm text-foreground"
              numberOfLines={1}
            >
              {summary.title}
            </Text>
