...
const NAME = "org.gnome.Shell.Extensions.RUNESnapShot";
const PATH = "/org/gnome/Shell/Extensions/RUNESnapShot";
...
function takeSnapshot(animate) {
  ...
  if (animate && St.Settings.get().enable_animations) {
    try {
      ...
      console.warn(`RUNE capture preview unavailable: ${error.message}`);
    }
  }
...
export default class RUNESnapShotExtension extends Extension {
  enable() {
