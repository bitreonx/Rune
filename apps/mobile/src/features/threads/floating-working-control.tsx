  ...
  return (
    <StatusLabelRow accessibilityLabel="Compacting" className="gap-1.5" onLayout={props.onLayout}>
      <SymbolView
        ...
        type="monochrome"
      />
      <Text className="font-RUNE-medium text-xs text-foreground">Compacting…</Text>
    </StatusLabelRow>
  );
}
  ...
  if (props.status.kind === "syncing") {
    return (
      ...
      >
        ...
        <Text className="shrink font-RUNE-medium text-xs text-foreground" numberOfLines={1}>
          {props.status.label}
        </Text>
      </StatusLabelRow>
    );
  ...
  if (props.status.kind === "connection") {
    return (
      ...
      >
        ...
        <Text
          className="max-w-[260px] shrink font-RUNE-medium text-xs text-foreground"
          numberOfLines={1}
        >
          {props.status.label}
        </Text>
    ...
    return (
      ...
      >
        ...
        <ShimmeringWorkContent
          className="flex-none"
          textClassName="font-RUNE-medium"
          compact
...
function WorkingDuration(props: {
  ...
  return (
    <StatusLabelRow accessibilityLabel={label} onLayout={props.onLayout}>
      <Text className="font-RUNE-medium text-xs text-foreground">Working for </Text>
      <SystemText
