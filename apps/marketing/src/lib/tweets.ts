...
export const tweets = [
  ...
  },
  {
    handle: "teja2495",
    content:
      "I’ve completely switched to RUNE for all my workflows. I just switch between different subscriptions and harnesses depending on what I need.",
    excerpt: "I’ve completely switched to RUNE for all my workflows.",
  ...
  },
  {
    ...
    content:
      "The minute RUNE supports Claude Code, it could potentially become my daily driver. There's something special there.",
    link: "https://x.com/tannerlinsley/status/2031102771529920966",
  },
  {
    handle: "aronprins",
    content:
      "I already loved RUNE by @theo and @jullerino, but their Connections implementation is next level epic and for this they should both earn maximum repect 🔥🫡",
    excerpt: "I already loved RUNE, but their Connections implementation is next level epic.",
  ...
  {
    handle: "ex0t1clol",
    content: "RUNE is proof electron apps don't have to suck",
  ...
  },
  {
    ...
    content: "Heartbreaking: AI-hater has to admit RUNE is really good.",
    link: "https://x.com/_winter_wonders/status/2052350198764970434",
  },
  {
    handle: "kostyniuk00",
    content:
      "I was not expecting a year ago, that my anti-AI colleagues would thank me a year later, for persuading them to try RUNE Beta, that really helped them with organizing their workflows. \n\nFantastic product by @jullerino and @theo. Go try it out if you haven’t yet!",
    excerpt:
      "My anti-AI colleagues thanked me for persuading them to try RUNE Beta. Fantastic product.",
    link: "https://x.com/kostyniuk00/status/2052041388179468521",
  },
  {
    handle: "gnukeith",
    content:
      "I tried RUNE it actually fixed issues that Opus couldn’t solve in Claude Code + Theo has replied with “UwU” under my post. Dario has not.",
    link: "https://x.com/gnukeith/status/2054670073579630730",
  },
  {
    handle: "peculiarnewbie",
    content: "RUNE is iOS and other harnesses are androids",
    link: "https://x.com/peculiarnewbie/status/2054671685027233827",
  },
  {
    handle: "leodev",
    content:
      "RUNE is probably the first coding gui that didn't suck performance wise and had a smart team behind it.",
  ...
  {
    handle: "iamkaffe",
    content: "Rune was the first one to truly care about Linux users.",
