...
import { ProviderInstanceId, ProviderSetupError, type ProviderAuthState } from "@rune/contracts";
...
const owner = "RUNE-auth-session-owner";
const otherOwner = "RUNE-auth-session-other";
