...
const SHOWCASE_LOCAL_ENVIRONMENT_DISPLAY_URLS: Readonly<Record<string, string>> = {
  ...
  "Suspense Station": "https://suspense-vps.hel1.rune.sh/",
...
const pocketPiEndpoint = {
  httpBaseUrl: "https://pocket-pi.rune.sh",
  wsBaseUrl: "wss://pocket-pi.rune.sh",
  providerKind: "rune_relay" as const,
};
...
export const SHOWCASE_CONNECTED_CLOUD_ENVIRONMENTS: ReadonlyArray<ConnectedEnvironmentSummary> = [
  {
    ...
    displayUrl: "https://aurora-gpu.rune.sh",
    isRelayManaged: true,
