 ...
 */
export declare const CLI_RUNTIME_EXTERNAL_PREFIXES: readonly ["node-pty", "ffi-rs", "@yuuang/", "@ff-labs/", "@clerk/electron-passkeys", "@msgpackr-extract/", "msgpackr-extract", "node-gyp-build", "node-addon-api", "detect-libc", "bufferutil", "utf-8-validate"];
/**
 ...
 */
export declare const CLI_BUILD_ONLY_EXTERNAL_PREFIXES: readonly ["@effect/platform-bun", "@effect/sql-sqlite-bun"];
export declare const CLI_EXTERNAL_PACKAGE_PREFIXES: readonly ["node-pty", "ffi-rs", "@yuuang/", "@ff-labs/", "@clerk/electron-passkeys", "@msgpackr-extract/", "msgpackr-extract", "node-gyp-build", "node-addon-api", "detect-libc", "bufferutil", "utf-8-validate", "@effect/platform-bun", "@effect/sql-sqlite-bun"];
...
export declare function selectCliRuntimeExternalDependencies(dependencies: Readonly<Record<string, string>>): Record<string, string>;
/**
