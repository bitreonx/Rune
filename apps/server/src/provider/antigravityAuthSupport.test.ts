...
describe("Antigravity process environment", () => {
  const profile: AntigravityProfile = {
    platform: "linux",
    geminiHome: "/RUNE/userdata/providers/antigravity/profile",
    acpDirectory: "/RUNE/userdata/providers/antigravity/profile/antigravity-acp",
    tokenPath: "/RUNE/userdata/providers/antigravity/profile/antigravity-acp/acp_token.json",
