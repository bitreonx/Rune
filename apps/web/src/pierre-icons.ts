...
const PIERRE_ICON_SPRITE_ID = "rune-pierre-file-icon-sprite";

const RUNE_FILE_ICON_SPRITE = `
<svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" aria-hidden="true">
  <symbol id="rune-file-icon-package-json" viewBox="0 0 32 32">
    <path d="M2 2H30V30H2" fill="#c12127" />
    <path d="M7.25 7.25h17.5v17.5h-3.5v-14H16v14H7.25" fill="#fff" />
  </symbol>
  <symbol id="rune-file-icon-tsconfig" viewBox="0 0 32 32">
  ...
  <symbol id="rune-file-icon-agents" viewBox="0 0 32 32">
  ...
  <symbol id="rune-file-icon-claude" viewBox="0 0 32 32">
  ...
  <symbol id="rune-file-icon-readme" viewBox="0 0 32 32">
  ...
  <symbol id="rune-file-icon-pnpm" viewBox="0 0 32 32">
...
export const RUNE_PIERRE_ICONS = {
  set: "complete",
  colored: true,
  spriteSheet: RUNE_FILE_ICON_SPRITE,
  byFileName: {
    "package.json": "rune-file-icon-package-json",
    "tsconfig.json": "rune-file-icon-tsconfig",
    "agents.md": "rune-file-icon-agents",
    "claude.md": "rune-file-icon-claude",
    "readme.md": "rune-file-icon-readme",
...
export function ensurePierreIconSprite(): void {
  ...
  container.innerHTML = `${getBuiltInSpriteSheet("complete")}${RUNE_FILE_ICON_SPRITE}`;
