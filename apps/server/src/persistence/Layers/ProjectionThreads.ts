...
import { ModelSelection, ThreadLinkedPullRequest } from "@rune/contracts";
    ...
    execute: (row) =>
      sql`
        INSERT INTO projection_threads (
          ...
          snoozed_at,
          temporary_at,
          temporary_deletion_snoozed_until,
          pinned_at,
          pin_order_key,
          active_order_key,
        ...
        VALUES (
          ...
          ${row.snoozedAt},
          ${row.temporaryAt},
          ${row.temporaryDeletionSnoozedUntil ?? null},
          ${row.pinnedAt},
        ...
        DO UPDATE SET
          ...
          chat_diff_json = excluded.chat_diff_json,
          chat_diff_through_turn_count = excluded.chat_diff_through_turn_count,
          file_ownership_json = excluded.file_ownership_json,
          ...
          temporary_at = excluded.temporary_at,
          temporary_deletion_snoozed_until = excluded.temporary_deletion_snoozed_until,
