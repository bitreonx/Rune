 ...
 * agent-device daemon in HTTP mode under a RUNE-owned state directory. Both are
 ...
 *
 * The hub runs in its standalone mode (origin root). The RUNE proxy strips its
