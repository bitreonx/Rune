import { ORCHESTRATION_WS_METHODS, WS_METHODS } from "@rune/contracts";
...
}>("@rune/client-runtime/rpc/EnvironmentRpcRequestObserver", {
  defaultValue: () => ({
...
export type EnvironmentSubscriptionRpcTag =
  ...
  | typeof WS_METHODS.subscribeProjectFileEvents
  | typeof WS_METHODS.schedulesSubscribe
...
}>("@rune/client-runtime/rpc/EnvironmentRpcSubscriptionObserver", {
  defaultValue: () => ({
    observe: () => Effect.succeed(Effect.void),
  }),
}) {}
