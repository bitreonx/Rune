import { type GrokSettings, ProviderDriverKind } from "@rune/contracts";
...
const RUNE_CODE_OAUTH_REFERRER = "rune";
...
export function buildGrokAcpSpawnInput(
  ...
  return {
    ...
    env: {
      ...environment,
      [GROK_OAUTH2_REFERRER_ENV]: RUNE_CODE_OAUTH_REFERRER,
    },
  };
}
...
/**
 * RUNE's built-in Grok slug. It is the CLI's product name, not a model id the ACP accepts,
