...
Item {
    ...
    // A cached, bounded PNG is shared by each output. Nothing repaints while waiting for RUNE.
    Image {
        id: snapshot
        visible: false
    ...
    DBusCall {
        id: next
        service: root.bus
        path: "/com/runetools/KdeCapture/Feedback"
        dbusInterface: "com.runetools.KdeCapture.Feedback"
        method: "Next"
