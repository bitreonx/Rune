import type { ServerSelfUpdateOutcome } from "@rune/contracts";
  ...
  override get message(): string {
    switch (this.operation) {
      ...
      case "version-mismatch":
        return "The service launcher started a different rune version.";
...
export const ServiceLauncherHostProcess = Context.Reference<ServiceLauncherProcess>(
  "@rune/server/cloud/serviceLauncherHostProcess",
  {
    defaultValue: () => ({
...
>()("@rune/server/cloud/serviceLauncherClient") {}
