...
declare const __RUNE_BUILD_CHANNEL__: "nightly" | "latest" | undefined;

export function resolveLoopbackAuthorizationStage(): LoopbackAuthorizationStage {
  return typeof __RUNE_BUILD_CHANNEL__ === "undefined" ? "dev" : __RUNE_BUILD_CHANNEL__;
}

const stageBrands = {
  dev: "RUNE (Dev)",
  nightly: "RUNE (Nightly)",
  latest: "RUNE",
...
<html lang="en">
  <head>
    ...
    <title>RUNE Connect authorization complete</title>
    <style>
      :root {
  ...
  <body>
    <main>
      ...
      <section class="content">
        ...
        <p class="description">Return to your terminal to finish setting up RUNE Connect. You can close this window.</p>
      </section>
    </main>
  </body>
</html>`;
