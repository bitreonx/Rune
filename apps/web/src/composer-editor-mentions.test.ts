import { EnvironmentId, MessageId, ThreadId, type AssistantCitation } from "@rune/contracts";
import { serializeAssistantCitation } from "@rune/shared/assistantCitations";
...
describe("splitPromptIntoComposerSegments", () => {
  ...
  it("keeps malformed citation links as editable text", () => {
    const prompt = "[Assistant quote](rune-citation://v1/env/thread/message?text=missing+metadata)";
