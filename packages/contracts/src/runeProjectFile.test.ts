...
import { RuneProjectFile } from "./runeProjectFile.ts";

const decode = Schema.decodeUnknownSync(RuneProjectFile);

describe("RuneProjectFile", () => {
  it("decodes a full project file", () => {
    const decoded = decode({
      $schema: "https://rune.dev/schema/rune.json",
