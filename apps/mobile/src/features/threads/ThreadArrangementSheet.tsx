...
import type { EnvironmentThreadShell } from "@rune/client-runtime/state/shell";
import { effectiveSnoozed } from "@rune/client-runtime/state/thread-settled";
      ...
      <GestureHandlerRootView style={{ flex: 1 }}>
        ...
        >
          <View className="flex-row items-center justify-between gap-3 px-5 py-3">
            <Text className="flex-1 text-xl font-RUNE-semibold">Arrange threads</Text>
            <Pressable
                ...
                return (
                  ...
                  >
                    {thread ? (
                      ...
                      >
                        <Text className="text-sm font-RUNE-semibold text-foreground-muted">
            ...
            {visiblePreview ? (
              ...
              >
                <Text
                  ...
                  className="text-base font-RUNE-medium"
                >
