...
// oxlint-disable-next-line rune/no-global-process-runtime -- Electron exposes the client platform in its sandboxed preload process.
...
contextBridge.exposeInMainWorld("desktopBridge", {
  ...
  invalidateLocalEnvironmentBearerToken: () =>
    ipcRenderer.invoke(IpcChannels.INVALIDATE_LOCAL_ENVIRONMENT_BEARER_TOKEN_CHANNEL),
