...
const GNOME_ACCESS_COPY = {
  "not-installed": {
    ...
    description:
      "The RUNE Code GNOME extension lets you capture other windows and bring them into your draft. Sign out once after installing.",
  },
  "restart-required": {
  ...
  disabled: {
    ...
    description: "Enable RUNE Code SnapShots to start capturing windows.",
  },
  enabled: {
  ...
  error: {
    ...
    description: "Check RUNE Code SnapShots in GNOME Extensions, then try again.",
  },
};
              ...
              : {
                  title:
                    helper?.status === "update-required"
                      ...
                      : "Allow snapshots",
                  description:
                    "RUNE Code's capture helper lets you capture other apps and return to your draft. It's included with RUNE Code.",
                }
          : backend === "niri"
            ? {
                title: "Capture is ready",
              ...
              <details className="text-xs text-muted-foreground">
                ...
                <div className="mt-3 space-y-3">
                  ...
                  {step === "access" && (backend === "gnome" || helperBackend) ? (
                    <p>Included with RUNE Code. No download needed.</p>
                  ) : null}
