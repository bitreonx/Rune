...
>()("@rune/desktop/app/DesktopEnvironment") {}

const APP_BASE_NAME = "RUNE";
...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  const userDataDirName = isDevelopment ? "rune-dev" : "rune";
  const legacyUserDataDirName = isDevelopment ? "rune-dev" : "rune";
  ...
  return DesktopEnvironment.of({
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? "dev.rune.desktop.dev" : "dev.rune.desktop",
    ),
    linuxDesktopEntryName: isDevelopment ? "rune-dev.desktop" : "rune.desktop",
    linuxWmClass: isDevelopment ? "rune-dev" : "rune",
