import { effectiveSettled } from "@rune/client-runtime/state/thread-settled";
import type { OrchestrationThreadShell } from "@rune/contracts";
import { ProjectId, ProviderInstanceId, ThreadId, type VcsStatusResult } from "@rune/contracts";
...
function status(overrides: Partial<VcsStatusResult> = {}): VcsStatusResult {
  return {
    ...
    pr: {
      number: 42,
      title: "PR branch",
      url: "https://github.com/rune-dev/rune/pull/42",
      baseRef: "main",
  ...
  it("after caching a merged PR, resolves main status back to the cached feature PR", () => {
    ...
    const mainStatus = status({
      ...
      pr: {
        ...
        url: "https://github.com/rune-dev/rune/pull/99",
        baseRef: "main",
        headRef: "main",
        state: "open",
      },
