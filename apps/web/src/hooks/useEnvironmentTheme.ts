import type { EnvironmentTheme } from "@rune/contracts";
...
function publishedThemeColors(
  ...
  // desktop theme arrives as a coherent RUNE Code palette rather than a foreign
 ...
 * than rendered: a published `RUNE-iris.json` would show this palette on its
