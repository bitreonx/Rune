			...
			"./node_modules/.pnpm/get-tsconfig@4.14.0/node_modules/get-tsconfig/dist/index.cjs"(e, t, i) {
				...
				const X = r((e, t) => Q(N(t, e, "utf8")), "readJsonc"), te = Symbol("implicitBaseUrl"), ie = "${configDir}", se = r(() => {
					...
					if (n.compilerOptions) {
						...
						for (const i of ["baseUrl", "rootDir"]) {
							const t = e[i];
							if (t && !t.startsWith(ie)) {
								const n = a.resolve(c, t);
								e[i] = ce(c, n);
							}
						}
						for (const t of de) {
				...
				const Ee = _e((e) => {
					...
					const n = a.dirname(t), { files: c, include: l, exclude: y, compilerOptions: E } = e, w = r((e) => a.isAbsolute(e) ? e : Se(n, e), "resolvePattern"), C = null == c ? void 0 : c.map(w), S = Te(E), I = i ? "" : "i", N = (y || Re(E)).map((e) => {
						const t = w(e), i = Ae(t).replaceAll(String.raw`\*\*/`, "(.+/)?").replaceAll(String.raw`\*`, `${Ve}*`).replaceAll(String.raw`\?`, Ve);
			...
			function resolvePackageTargetString(e, t, i, n, a, c, l, y, E) {
				...
				if (null !== At.exec(t)) {
					...
					if (null === Pt.exec(t)) {
						...
						const c = `request is not a valid match in pattern "${t}" for the "${n ? "imports" : "exports"}" resolution of ${(0, Qe.fileURLToPath)(i)}`;
						throw new Et(e, c, a && (0, Qe.fileURLToPath)(a));
					})(E, i, n, l, a);
				}
