...
const rule = createOxlintRuleHarness("rune/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("rune/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("rune/no-manual-effect-runtime-in-tests");
...
const legacyRule = createOxlintRuleHarness("rune/no-manual-effect-runtime-in-tests", {
  filename: "legacy.test.ts",
  ruleOptions: [{ maxOccurrences: 2 }],
});

describe("rune/no-manual-effect-runtime-in-tests with maxOccurrences", () => {
  legacyRule.valid(
