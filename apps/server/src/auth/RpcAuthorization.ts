...
export const RPC_REQUIRED_SCOPES = {
  ...
  [ORCHESTRATION_WS_METHODS.getChatDiff]: AuthOrchestrationReadScope,
  [ORCHESTRATION_WS_METHODS.searchThreads]: AuthOrchestrationReadScope,
  [ORCHESTRATION_WS_METHODS.getAgentChat]: AuthOrchestrationReadScope,
  [ORCHESTRATION_WS_METHODS.sendAgentMessage]: AuthOrchestrationOperateScope,
  [ORCHESTRATION_WS_METHODS.interruptAgentMessage]: AuthOrchestrationOperateScope,
  [ORCHESTRATION_WS_METHODS.subscribeShell]: AuthOrchestrationReadScope,
  [ORCHESTRATION_WS_METHODS.getArchivedShellSnapshot]: AuthOrchestrationReadScope,
  [ORCHESTRATION_WS_METHODS.subscribeThread]: AuthOrchestrationReadScope,
  [CROSS_THREAD_WS_METHODS.listForPicker]: AuthOrchestrationReadScope,
  [CROSS_THREAD_WS_METHODS.capsulePreview]: AuthOrchestrationReadScope,
  [CROSS_THREAD_WS_METHODS.capsuleExpand]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.skillsRefresh]: AuthOrchestrationReadScope,
  [WS_METHODS.skillsGetBody]: AuthOrchestrationReadScope,
  [WS_METHODS.actionsList]: AuthOrchestrationReadScope,
  [WS_METHODS.actionsListProposals]: AuthOrchestrationReadScope,
  [WS_METHODS.actionsListRunHistory]: AuthOrchestrationReadScope,
  [WS_METHODS.actionsCreate]: AuthOrchestrationOperateScope,
  [WS_METHODS.actionsVersion]: AuthOrchestrationOperateScope,
  [WS_METHODS.actionsCreateProposal]: AuthOrchestrationOperateScope,
  [WS_METHODS.actionsApproveProposal]: AuthOrchestrationOperateScope,
  [WS_METHODS.actionsRejectProposal]: AuthOrchestrationOperateScope,
  [WS_METHODS.actionsDismissProposal]: AuthOrchestrationOperateScope,
  [WS_METHODS.actionsRecordRun]: AuthOrchestrationOperateScope,
  [WS_METHODS.actionsRun]: AuthOrchestrationOperateScope,
  [WS_METHODS.schedulesList]: AuthOrchestrationReadScope,
  [WS_METHODS.schedulesGet]: AuthOrchestrationReadScope,
  [WS_METHODS.schedulesRuns]: AuthOrchestrationReadScope,
  [WS_METHODS.schedulesSubscribe]: AuthOrchestrationReadScope,
  [WS_METHODS.schedulesCreate]: AuthOrchestrationOperateScope,
  [WS_METHODS.schedulesUpdate]: AuthOrchestrationOperateScope,
  [WS_METHODS.schedulesPause]: AuthOrchestrationOperateScope,
  [WS_METHODS.schedulesResume]: AuthOrchestrationOperateScope,
  [WS_METHODS.schedulesDelete]: AuthOrchestrationOperateScope,
  [WS_METHODS.schedulesRunNow]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.subscribeProjectFileEvents]: AuthOrchestrationReadScope,
  [WS_METHODS.pocketsSnapshot]: AuthOrchestrationReadScope,
  [WS_METHODS.pocketsDispatch]: AuthOrchestrationOperateScope,
  [WS_METHODS.pocketsImportLegacy]: AuthOrchestrationOperateScope,
  [WS_METHODS.executionControllerSnapshot]: AuthOrchestrationReadScope,
  [WS_METHODS.executionControllerDispatch]: AuthOrchestrationOperateScope,
  [WS_METHODS.planSessionCreate]: AuthOrchestrationOperateScope,
  [WS_METHODS.planSessionGet]: AuthOrchestrationReadScope,
  [WS_METHODS.planSessionUpdate]: AuthOrchestrationOperateScope,
  [WS_METHODS.planSessionTransition]: AuthOrchestrationOperateScope,
  [WS_METHODS.planSessionResume]: AuthOrchestrationOperateScope,
  [WS_METHODS.planSessionSchedule]: AuthOrchestrationOperateScope,
  [WS_METHODS.planSessionReview]: AuthOrchestrationOperateScope,
  [WS_METHODS.chatMutationList]: AuthOrchestrationReadScope,
  [WS_METHODS.chatMutationAppend]: AuthOrchestrationOperateScope,
  [WS_METHODS.chatMutationSettle]: AuthOrchestrationOperateScope,
