...
export function ThreadCreationFailedCard(props: {
  ...
  return (
    <View className="gap-2.5 rounded-[20px] border border-adaptive-neutral-200-white-a6 bg-adaptive-neutral-100-900 p-4">
      <Text className="font-RUNE-bold text-2xs uppercase tracking-[1.1px] text-adaptive-rose-700-300">
      ...
      <View className="flex-row">
        ...
        >
          <Text className="text-sm font-RUNE-extrabold text-white">Edit task</Text>
        </Pressable>
      </View>
    </View>
  );
