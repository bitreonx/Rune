import type { BrowserImportSource } from "@rune/contracts";
import { BROWSER_IMPORT_FAILURE_COPY } from "@rune/contracts";
...
function FullDiskAccessStep({
  ...
  return (
    <>
      <DialogHeader>
        <DialogTitle>Let RUNE Code read {source.name}&rsquo;s cookies</DialogTitle>
        <DialogDescription>
          To import cookies from {source.name}, RUNE Code needs Full Disk Access. Turn it on in System
      ...
      {stillRequired ? (
        <DialogPanel>
          <p role="status" className="text-sm text-muted-foreground">
            Full Disk Access is still required. If you just turned it on, quit and reopen RUNE Code,
            then try again.
          </p>
        </DialogPanel>
      ) : null}
