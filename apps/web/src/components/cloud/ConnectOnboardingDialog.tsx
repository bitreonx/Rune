...
import { AuthAdministrativeScopes, AuthRelayWriteScope } from "@rune/contracts";
...
import { WizardSteps, WizardPanel, WizardFooter } from "../ui/wizard";

/**
 * Post-sign-in onboarding wizard for RUNE Connect. Opens on every in-session
 ...
 * account's RUNE Connect environments so every device can be connected right
  ...
  return (
    ...
    >
      <DialogPopup className="max-w-xl">
        <DialogHeader>
          <DialogTitle>Set up RUNE Connect</DialogTitle>
          <DialogDescription>
  ...
  return (
    <div className="space-y-3">
      <div className="rounded-lg border">
        ...
        description="Make this environment available to your other devices through RUNE Connect."
