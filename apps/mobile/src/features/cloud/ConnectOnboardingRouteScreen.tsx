...
import { reportAtomCommandResult, settlePromise } from "@rune/client-runtime/state/runtime";
...
/**
 * Post-sign-in onboarding sheet for RUNE Connect. Mobile never publishes
 * environments itself — it consumes ones published elsewhere — so this simply
 * surfaces the account's RUNE Connect environments right after sign-in so every
        ...
        {isSignedIn ? (
          ...
          <View collapsable={false} className="rounded-[24px] bg-card p-5">
            <Text className="text-sm leading-normal text-foreground-muted">
              Sign in to your RUNE account to set up RUNE Connect.
            </Text>
          </View>
        )}
