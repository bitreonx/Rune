import { readConnectAuthorizeRequest } from "@rune/shared/connectAuth";
...
const TEST_ENV = {
  RUNE_CLERK_PUBLISHABLE_KEY: "pk_test_Y2xlcmsuZXhhbXBsZS50ZXN0JA==",
  RUNE_CLERK_CLI_OAUTH_CLIENT_ID: "oauth_client_test",
  RUNE_HOSTED_APP_URL: "https://hosted.example.test",
};
