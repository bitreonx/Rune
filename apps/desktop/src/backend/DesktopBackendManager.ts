...
import { waitForHttpReady as waitForHttpReadyShared } from "@rune/shared/httpReadiness";
...
export const DEFAULT_BACKEND_READINESS_TIMEOUT_MS = 30_000;
export const DEFAULT_BACKEND_READINESS_PROBE_TIMEOUT_MS = 2_000;
const DEFAULT_BACKEND_READINESS_TIMEOUT = Duration.millis(DEFAULT_BACKEND_READINESS_TIMEOUT_MS);
const DEFAULT_BACKEND_READINESS_INTERVAL = Duration.millis(100);
const DEFAULT_BACKEND_READINESS_REQUEST_TIMEOUT = Duration.millis(
  DEFAULT_BACKEND_READINESS_PROBE_TIMEOUT_MS,
);
const DEFAULT_BACKEND_TERMINATE_GRACE = Duration.seconds(2);
const DEFAULT_BACKEND_OUTPUT_DRAIN_TIMEOUT = Duration.seconds(5);
const BACKEND_READINESS_PATH = ".well-known/rune/environment";
...
export interface DesktopBackendStartConfig extends BackendProcessContext {
  ...
  // RUNE_HOME can't pin the WSL backend to /mnt/c/.../.rune.
...
export const waitForHttpReady = (
  ...
  const probeTimeout = options.probeTimeout ?? DEFAULT_BACKEND_READINESS_REQUEST_TIMEOUT;
