...
describe("isLegalDocumentUrl", () => {
  it.each([
    "https://rune.dev/legal",
    "https://rune.dev/legal/",
    "https://rune.dev/privacy-policy?source=app",
    "https://rune.dev/terms-of-service#updates",
    "https://rune.dev/security-policy",
  ])("allows a configured legal document: %s", (url) => {
    expect(isLegalDocumentUrl(url)).toBe(true);
  });

  it.each([
    "https://rune.dev/download",
