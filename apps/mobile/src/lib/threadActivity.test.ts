...
describe("buildThreadFeed", () => {
  it("excludes hidden messages from the feed", () => {
    const thread = makeThread({
      id: ThreadId.make("thread-hidden-mobile"),
      projectId: ProjectId.make("project-1"),
      title: "Hidden nudge",
      messages: [
        {
          id: MessageId.make("message-visible"),
          role: "user" as const,
          text: "fix the bug",
          turnId: null,
        ...
        {
          id: MessageId.make("message-hidden"),
          role: "user" as const,
          text: "Continue.",
          turnId: null,
    ...
    expect(feed.map((entry) => entry.id)).toEqual(["message-visible"]);
  });
  ...
  it.each([
    {
      ...
      label: "Call MCP tool",
      title: "Call MCP tool",
      item: { server: "RUNE-code", tool: "preview_navigate" },
      status: "inProgress",
    ...
    },
    {
      ...
      label: "Call MCP tool",
      title: "Call MCP tool",
      item: { server: "RUNE-code", tool: "task_status" },
      status: "inProgress",
    ...
    },
    {
      ...
      label: "Call MCP tool",
      title: "mcp__rune-code__preview_snapshot",
      item: undefined,
      status: "inProgress",
    ...
    },
    {
      ...
      label: "mcp__rune-code__task_status",
      title: undefined,
      item: undefined,
      status: "inProgress",
      displayName: "Getting delegated task status",
    ...
    },
    {
      ...
      label: "Call MCP tool",
      title: "Call MCP tool",
      item: { server: "RUNE-code", tool: "preview_click" },
      status: undefined,
  ...
  it("retains Claude MCP metadata behind friendly row and running labels", () => {
    ...
    const toolData = {
      toolName: "mcp__rune-code__preview_click",
          ...
          makeActivity({
            ...
            payload: {
              ...
              ...(index < commandCount
                ...
                : {
                    itemType: "mcp_tool_call",
                    data: { item: { server: "RUNE-code", tool: "preview_click" } },
                  }),
            },
          }),
        ),
