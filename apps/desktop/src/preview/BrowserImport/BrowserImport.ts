 ...
 * into a RUNE Code browser profile's Electron partition.
 *
...
import { BrowserImportFailureReason } from "@rune/contracts";
...
>()("@rune/desktop/preview/BrowserImport/BrowserImport") {}
