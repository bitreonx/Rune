...
const guardedMobileFile = createOxlintRuleHarness("rune/no-mobile-uniwind-theme-escape-hatches", {
  filename: "apps/mobile/src/features/settings/NewThemeSurface.tsx",
});
const reviewedInteropFile = createOxlintRuleHarness(
  "rune/no-mobile-uniwind-theme-escape-hatches",
  {
...
describe("rune/no-mobile-uniwind-theme-escape-hatches", () => {
