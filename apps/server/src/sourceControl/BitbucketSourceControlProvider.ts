...
import { SourceControlProviderError, type ChangeRequest } from "@rune/contracts";
...
export const makeDiscovery = Effect.gen(function* () {
  ...
  return {
    ...
    label: "Bitbucket",
    installHint:
      "Set RUNE_BITBUCKET_EMAIL and RUNE_BITBUCKET_API_TOKEN on the server (use a Bitbucket API token with pull request, repository, and user read scopes).",
