...
export const CompactComposerControlsMenu = memo(function CompactComposerControlsMenu(props: {
  ...
  /** Only surfaces that can arm a temporary chat offer the toggle. */
      ...
      <MenuPopup align="start">
        ...
        {props.showInteractionModeToggle ? (
          <>
            ...
            {props.showTemporaryToggle ? (
              <MenuCheckboxItem
                checked={props.temporaryChat === true}
                onCheckedChange={() => props.onToggleTemporaryChat?.()}
              >
                Temporary chat
              </MenuCheckboxItem>
            ) : null}
