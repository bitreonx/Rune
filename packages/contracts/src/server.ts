...
/**
 * A palette the environment's machine publishes for RUNE Code to follow, read
 ...
 * over as a coherent RUNE Code palette instead of a foreign one.
 */
...
export const ServerSelfUpdateInput = Schema.Struct({
  /** Exact npm version of the `rune` package to install (never a dist-tag, so
