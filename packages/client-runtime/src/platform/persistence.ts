...
>()("@rune/client-runtime/platform/persistence/ConnectionTargetStore") {}
...
>()("@rune/client-runtime/platform/persistence/ConnectionRegistrationStore") {}
...
>()("@rune/client-runtime/platform/persistence/EnvironmentCacheStore") {}
...
}>("@rune/client-runtime/platform/persistence/EnvironmentOwnedDataCleanup", {
  defaultValue: () => ({
    clear: () => Effect.void,
  }),
}) {}
