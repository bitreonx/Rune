    ...
    return (
      <View className="flex-1 items-center justify-center gap-4 bg-sheet px-8">
        ...
        <View className="items-center gap-2">
          <Text className="text-center font-rune-bold text-lg text-foreground">
        ...
        <View className="w-full max-w-[320px] gap-2">
          ...
          >
            <Text className="font-rune-bold text-base text-sheet">Try Again</Text>
          </Pressable>
          <Pressable
          ...
          >
            <Text className="font-rune-medium text-base text-foreground-muted">Open in Browser</Text>
          </Pressable>
        </View>
      </View>
    );
