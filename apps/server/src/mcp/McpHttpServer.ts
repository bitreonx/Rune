...
import { RuneControlToolkit } from "./toolkits/runeControl/tools.ts";
import { RuneControlToolkitHandlersLive } from "./toolkits/runeControl/handlers.ts";
    ...
    (registry): McpAuthMiddleware =>
      Effect.fn("McpHttpServer.authenticateRequest")(function* (httpEffect) {
        ...
        if (!invocation) {
          ...
          // quietly losing the whole `rune` toolkit for the rest of its
...
export const RuneControlToolkitRegistrationLive = McpServer.toolkit(RuneControlToolkit).pipe(
...
export const layer = Layer.mergeAll(
  ...
  RuneControlToolkitRegistrationLive,
